...
export const exchangeCognitoToken = async (
  code: string,
): Promise<{ user: UserInfo; tokens: TokenResponse } | null> => {
  // const { appGlobalData } = useGlobalContext();
  // const { domain, clientId, redirectUri } =
  //   appGlobalData.cognitoDetails || {};
